  ...
  <div style="background:#f0f2f5;margin-top: -20px;height:100%;">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">请检查您输入的网址是否正确，请点击以下按钮返回主页或者联系管理人员</div>
...
<script>
import img404 from '@/common/image/png/404.png'
import img404cloud from '@/common/image/png/404_cloud.png'
