  ...
  <el-menu class="navbar" mode="horizontal">
    ...
    <div class="right-menu">
      <!-- <error-log class="errLog-container right-menu-item"></error-log> -->
        ...
        <!-- 全屏 -->
        <screenFull  class="screenfull right-menu-item nx-help" style="line-height: 3.7;cursor:pointer"></screenFull>
        <!-- 语言选择 -->
        <el-tooltip effect="dark" content="语言切换" placement="bottom">
            <lang-select class="set-language right-menu-item"></lang-select>
        </el-tooltip>
        <span class="nx-help">
          <span>帐号：</span><el-tag style="margin-right: 20px;">{{account}}</el-tag>
          <span>角色：</span>
    ...
    <!--弹出窗口：修改密码-->
    <el-dialog title="修改密码" :visible.sync="dialogVisible" width="20%" v-dialogDrag>
...
import Breadcrumb from '@/components/Breadcrumb' // 横向导航
