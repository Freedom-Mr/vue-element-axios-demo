<template>
  <div class="app-container">
    ...
    <!--列表-->
    <el-table :data="users" highlight-current-row style="width: 100%;" size="mini" v-loading="loading" :row-style="tableRowStyle" :header-cell-style="tableHeaderColor" show-overflow-tooltip border stripe>
